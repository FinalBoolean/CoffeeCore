...
public class ScaffoldCommand extends SubCommand {
    ...
    protected void perform(CommandSender sender, String[] args) {
        ...
        if (profile.isScaffoldMode()) {
            ...
            sender.sendMessage(Messenger.PREFIX + "You have enabled the arena scaffold mode, type `Done` in chat once you're finished, `Cancel` to cancel");
            p.getInventory().addItem(CoffeeUtils.scaffoldArenaItem());
        }
    }
