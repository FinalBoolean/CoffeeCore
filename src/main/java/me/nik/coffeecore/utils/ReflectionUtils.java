...
import me.nik.coffeecore.utils.custom.CoffeeException;
...
public final class ReflectionUtils {
    ...
    public static Method getMethod(final Class<?> clazz, final String methodName, final Class<?>... params) {
        ...
        try {
            ...
            throw new CoffeeException("Couldn't find method at class " + clazz.getSimpleName());
        }
    }
    ...
    public static Field getField(final Class<?> clazz, final String fieldName) {
        ...
        throw new CoffeeException("Couldn't find field at class " + clazz.getSimpleName());
    }
